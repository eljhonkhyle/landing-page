    ...
    <section>
      ...
      <footer className="top">
        ...
        <div className="why-choose">
          ...
          <p>
            <strong>📍 Personalized Tours:</strong> <br></br>See your future
            living space before you decide.
          </p>
          <p>
            <strong>🏡 Prime Locations:</strong> <br></br>Easy access to local
            amenities, schools, and transportation.
          </p>
          <p>
            <strong>💰 Affordable Options:</strong> <br></br>Quality rooms that
            suit your budget.
          </p>
        </div>
      </footer>
