    ...
    <div className='hero-section'>
      <div className='hero-text'>
        ...
        <p className='about'>
          ...
          With properties across the San Antonio TX area. </p>
          <p className='about2'>Our rooms are located in well-connected neighborhoods in Texas. Explore our properties or available rooms in person to find the perfect fit.</p>
